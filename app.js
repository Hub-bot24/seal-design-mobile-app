...
const state = { lookups: null, binderMatrix: null, deferredPrompt: null, hueskerBondCoatManual: false, hueskerTargetManual: false, glasgridResidualManual: false };
...
function syncHueskerInputs(e) {
  ...
  if (name === 'hueskerBondCoat') state.hueskerBondCoatManual = true;

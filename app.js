...
const state = { lookups: null, binderMatrix: null, deferredPrompt: null, hueskerBondCoatManual: false, hueskerTargetManual: false };
...
Aggregate application rate: ${r.agg.displayM2M3 || round(r.agg.m2m3,0)} m²/m³${secondText}${hueskerText}
